...
<style>
	...
	/* 15% fill, 40% border, ink darkened towards the foreground — the treatment
	   ...
	   Carried to 55% rather than the handoff's 68%: over a 15% wash of the same
	   hue, the greens and teals sat at 3.7:1 on the light theme, and the
	   guidelines ask AA of every pill. */
	.chip {
		display: inline-flex;
		align-items: center;
