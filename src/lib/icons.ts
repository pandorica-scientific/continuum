...
export const ICONS = {
	...
	// The horizontal pair, mirrored from the vertical ones so a derivation drawn
	// sideways ("income produces the return") matches one drawn downwards.
	arrowRight: [{ line: [4, 12, 20, 12] }, { path: 'M14 6l6 6-6 6' }],
